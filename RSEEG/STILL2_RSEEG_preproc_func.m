function [ outEEG ] = STILL2_RSEEG_preproc_func( inEEG , desiredFs, lowCut, highCut)
...
% *** USEAGE ***
%
% outEEG = STILL2_RSEEG_preproc_func( inEEG, desiredFs, lowCut, highCut )
%
...
fc=0.9;
df=0.2;
EEG = pop_resample( inEEG, desiredFs,fc,df);
disp(['resampled with : ' num2str(EEG.srate) 'Hz']);
